...
void main() {
  ...
  group('NostrService Relay Persistence', () {
    ...
    test('should save relay configuration to SharedPreferences when relay is added', () async {
    ...
    test('should remove relay from SharedPreferences when relay is removed', () async {
      // Arrange: Create service with a relay already configured
      SharedPreferences.setMockInitialValues({
        'configured_relays': ['wss://relay.divine.video', 'wss://old.relay.com']
      });

      final service = NostrService(keyManager);
      await service.initialize(customRelays: ['wss://relay.divine.video', 'wss://old.relay.com']);
    ...
    test('should use default relay when no saved configuration exists', () async {
    ...
    test('should persist relay configuration across simulated app restarts', () async {
    ...
    test('should clear old relay3.openvine.co from storage during migration', () async {
